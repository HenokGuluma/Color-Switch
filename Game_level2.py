...
path='C:/Users/Henok/Documents/python homework 1/Final Project/'
pygame.init()
pygame.mixer.init()
...
def restart(): 
    ...
    for i in range(100):
        ...
        t=r[1]
        u=r[2]
        temp = Circle(screen, s, t, u, WID/2, -500*i)
...
def draw_menu():
    screen.fill((0, 0, 0))
    bg=pygame.image.load(path+"picture.png").convert_alpha()
    #This displays the menu. 
    screen.blit(bg, (0, 0))
def draw_game_over():
    #when the game is over this picture is displayed along with score and highscore. 
    screen.fill((0, 0, 0))
    bg=pygame.image.load(path+"picture2.png").convert_alpha()
    screen.blit(bg, (0, 0))
